...
!function( $ ) {
	...
	TabDrop.prototype = {
		...
		layout: function() {
			...
			var prevItem = null;
			var addPrevItem = this.dropdown.position().top > 0;
			...
			this.element
				...
				.each(function(){
					if(this.offsetTop > 10) {
						//if (addPrevItem) collection.push(prevItem);
						//else collection.push(this);	
						collection1.push(this);
						collection2.push(prevItem);
						//collection.push(this);
					}
					prevItem = this;
				});
				
			//if (addPrevItem && prevItem != null && collection.length > 0) collection.push(prevItem);
			collection = addPrevItem ? collection2 : collection1;
